...
Router.map(function() {
	...
	this.route('bookEdit', {
		...
		data: function() { 
			//return Books.findOne(this.params._id);
			//console.log(this.params._id._str);
			//IDAsString = this.params._id._str ? this.params._id._str : this.params._id
			return Books.findOne({_id: new Meteor.Collection.ObjectID(this.params._id)});
			//return Books.findOne(IDAsString);
		}
	});
